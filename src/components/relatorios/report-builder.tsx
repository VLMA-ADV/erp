...
const ENTITIES: EntityConfig[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'email', label: 'E-mail', default: true },
      { key: 'whatsapp', label: 'WhatsApp', default: true },
      { key: 'oab', label: 'OAB', default: false },
      { key: 'cargo_nome', label: 'Cargo', default: true },
      { key: 'area_nome', label: 'Centro de Custo', default: true },
      { key: 'categoria', label: 'Categoria', default: false },
      { key: 'ativo', label: 'Ativo', default: true },
      { key: 'data_entrada', label: 'Data de Entrada', default: true },
      { key: 'data_saida', label: 'Data de Saída', default: false },
      { key: 'data_nascimento', label: 'Data de Nascimento', default: false },
      { key: 'salario', label: 'Salário', default: false },
      { key: 'adicional', label: 'Adicional', default: false },
      { key: 'percentual_adicional', label: '% Adicional', default: false },
      { key: 'banco', label: 'Banco', default: false },
      { key: 'agencia', label: 'Agência', default: false },
      { key: 'conta_com_digito', label: 'Conta', default: false },
      { key: 'chave_pix', label: 'Chave PIX', default: false },
      { key: 'cep', label: 'CEP', default: false },
      { key: 'rua', label: 'Rua', default: false },
      { key: 'numero', label: 'Número', default: false },
      { key: 'complemento', label: 'Complemento', default: false },
