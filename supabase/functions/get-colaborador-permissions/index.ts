...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Get colaborador permissions usando função RPC
    const { data: permissions, error: permissionsError } = await supabase
      .rpc('get_colaborador_permissions', { p_colaborador_id: colaboradorId });

    if (permissionsError) {
      console.error("Error fetching colaborador permissions:", permissionsError);
      return new Response(
        JSON.stringify({ 
