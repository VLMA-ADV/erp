-- Horas lançadas em casos do tipo 'projeto' devem ser classificadas/agrupadas
-- como Projeto (não Horas) nas telas de aprovação (Revisão de fatura / Fluxo).
-- Expõe o regra_cobranca do CASO para o front decidir a aba, já que o snapshot
-- de itens de timesheet nunca carrega regra_cobranca.
