-- Cliente (15/07): aprovador tem AUTONOMIA TOTAL — pode aprovar item a item
-- mesmo com horas de outros centros de custo ainda em revisão no caso.
-- Remove a trava dura multi-CC da aprovação (vira aviso informativo no front).
