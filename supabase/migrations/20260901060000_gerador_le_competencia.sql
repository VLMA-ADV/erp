-- =====================================================================
-- Faturamento do mes: horas do mes anterior + mensalidade do proprio mes,
-- ambas disponiveis desde o dia 1o
--
-- Duas mudancas que o Filipe confirmou em 01/09, e que precisam andar juntas:
--
-- 1. O GERADOR passa a ler a competencia da hora (periodo_faturamento), como a
--    tela ja lia desde 31/08. Estavam divergentes: a tela de setembro mostrava
--    1.827 horas e o gerador, no mesmo periodo, pegaria 1. Divergencia entre o
--    que se confere e o que se fatura e a pior especie — a pessoa aprova uma
--    coisa e sai outra, sem erro na tela.
--
-- 2. Sai a trava do "no mes corrente so entra depois do dia X". Ela existia
--    para nao antecipar mensalidade dentro do mes, mas o escritorio fatura no
--    dia 1o: "quero cobrar as mensalidades de setembro no comeco do mes".
--    Com a trava, gerar em 01/09 trazia ZERO mensalidade (em outubro trazia 86).
--
-- As duas juntas de proposito: subir so a 1 deixaria o quadro pior — horas
-- entrando e mensalidade nao, no dia do faturamento.
-- =====================================================================
