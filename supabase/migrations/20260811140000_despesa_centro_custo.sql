-- Centro de custo na despesa (pedido Filipe 11/08: evolucao por centro de custo
-- no Resumo). O centro de custo e a area da pessoa que lancou — e assim que o
-- resto do sistema trata, inclusive a regra de visibilidade logo abaixo, que ja
-- compara cb.area_id. Campo aditivo: nada que ja era devolvido mudou.
