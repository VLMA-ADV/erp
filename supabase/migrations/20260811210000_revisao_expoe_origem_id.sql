-- get_revisao_fatura devolve o origem_id do item.
--
-- A Nota de Despesas precisa listar exatamente as despesas que estao sendo
-- cobradas naquela fatura. Sem o origem_id nao da para ligar o item de
-- cobranca de volta na despesa, e a nota tinha que adivinhar por status.
-- Campo aditivo.
