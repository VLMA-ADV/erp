-- Bugs do cliente (15/07 19h):
-- 1) Revisar o texto sobrescrevia o ORIGINAL (snapshot + timesheet) ->
--    Envio mostrava o texto novo e a tag virava 'Sem alterações'.
--    Agora a 1ª edição preserva timesheet_{descricao,data,profissional}_original.
-- 2) Alterar o valor/hora na regra do caso não refletia nos itens pendentes:
--    get_revisao_fatura passa a expor valor_hora_atual da regra hora do caso.
