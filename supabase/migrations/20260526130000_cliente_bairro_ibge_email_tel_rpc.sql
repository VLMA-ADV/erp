-- Adiciona p_bairro, p_codigo_ibge, p_email, p_telefone às RPCs
-- create_cliente e update_cliente para persistir dados de endereço
-- completo (bairro + código IBGE do ViaCEP) e contato direto do cliente.
--
-- Colunas já existem na tabela crm.clientes (adicionadas previamente).
-- DROP explícito das assinaturas anteriores (24 params) para evitar
-- overloads perigosos no PostgREST.

BEGIN;

-- ============================================================
-- DROP assinaturas anteriores (BB-8, 24 params cada)
-- ============================================================
...
begin
  ...
  insert into crm.clientes (
    ...
    p_codigo_ibge, p_email, p_telefone,
