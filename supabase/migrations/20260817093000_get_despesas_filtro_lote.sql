-- =====================================================================
-- get_despesas: filtrar por lote
--
-- Filipe, 17/08: "quero que replique a estrutura do lancamento da despesa
-- nesta tela, de modo que o financeiro nao precise sair do modulo para fazer
-- essa funcao". Para mostrar as despesas de um lote dentro de contas a pagar,
-- falta ao get_despesas justamente o filtro por lote — ele filtra por
-- contrato, caso, status, categoria e data, mas nao por lote.
--
-- Unica mudanca em relacao a versao anterior: a linha do lote_id.
-- =====================================================================
