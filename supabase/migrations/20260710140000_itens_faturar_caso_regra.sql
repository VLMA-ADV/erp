-- B3: a hora lançada herda a regra de cobrança do CASO desde a etapa 1.
-- get_itens_a_faturar expõe caso_regra nas linhas de timesheet para o front
-- agrupar na aba certa (mensalidade de processo, projeto etc.), não em Horas.
  ...
  RETURN (
    WITH base_timesheet AS (
      SELECT
        ...
        -- regra de cobrança do caso: define em qual aba a hora aparece
        COALESCE(
          NULLIF(cs.regras_financeiras->0->>'regra_cobranca', ''),
