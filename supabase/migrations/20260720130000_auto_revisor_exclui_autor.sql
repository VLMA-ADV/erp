-- Feedback 20/07: revisor automático por CC sugeria o próprio autor quando a
-- área tem múltiplos coordenadores (Societário: Tiago, Victor Hugo e Rafael —
-- Rafael lança e aparecia como revisor por ordem alfabética). O autor agora é
-- a última opção na sugestão automática.
...
BEGIN
  ...
  RETURN (
    ...
    LEFT JOIN LATERAL (
      ...
      ORDER BY (co.user_id IS NOT DISTINCT FROM bi.created_by), co.nome
      LIMIT 1
