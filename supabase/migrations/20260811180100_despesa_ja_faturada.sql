-- get_despesas informa se a despesa ja virou item de cobranca.
--
-- A Jessika precisa listar as reembolsaveis para emitir a nota de debito
-- (pedido Filipe 11/08). Sem esse marcador ela nao teria como saber que uma
-- despesa ja foi para a fatura, e cobraria o cliente duas vezes.
