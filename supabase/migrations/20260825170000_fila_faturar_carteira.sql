-- =====================================================================
-- Cobranca por carteira volta a aparecer na conferencia de faturamento
--
-- Filipe, 25/08, fazendo o batimento do mes: casos com mensalidade que nao
-- apareciam na fila. Investigando, o caso dele era cadastro — mas no caminho
-- apareceu isto, que e nosso.
--
-- Quando a cobranca por carteira entrou (PR-1 de carteira, 30/04), ela foi
-- ensinada ao start_faturamento_flow, que GERA o faturamento, e nao ao
-- get_itens_a_faturar, que LISTA o que ha para faturar. O IN da regra_mensal
-- ficou com tres tipos e a carteira de fora.
--
-- Resultado: 10 casos ativos que cobram por carteira nunca apareceram na
-- conferencia mensal — R$ 9.800/mes entre os que tem valor cadastrado. O
-- dinheiro so sairia se alguem gerasse o faturamento sem conferir.
--
-- Vai junto a trava 'parte_de_carteira_id IS NULL', que o flow sempre teve e a
-- fila nunca: so a matriz fatura. Hoje nao existe filho de carteira na base, e
-- e por isso que a hora de por a trava e agora, e nao depois que existir.
-- =====================================================================
