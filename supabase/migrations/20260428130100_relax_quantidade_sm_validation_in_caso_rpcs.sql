...
BEGIN
  ...
  IF v_regras_financeiras IS NOT NULL
    ...
    -- BB-relax-sm: validação removida da RPC. Frontend mostra aviso
    -- visual quando regra=salario_minimo sem quantidade. Diretiva
    -- "forms soltos" (Filipe daily 27/04) — banco aceita valor null
    -- e o cálculo de faturamento futuro skipa/avisa em vez de falhar
    -- no save.
    NULL;
  END IF;
