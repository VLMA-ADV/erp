-- B4: 'Gerar faturamento do mês' processa SÓ as regras ativas do mês.
-- Horas ficam de fora (aparecem conforme lançadas e o financeiro envia em
-- lote quando quiser) — semântica da call de 08/07.
