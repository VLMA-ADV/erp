-- get_itens_a_faturar respeita timesheets.excluido_faturamento
-- (20260812100000_excluir_da_fila_de_faturar.sql): quem foi excluido da
-- fila de 'A liberar' nao pode voltar a aparecer nela.
