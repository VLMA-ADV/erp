-- =====================================================================
-- get_itens_a_faturar: respeitar os adiamentos
--
-- Duas mudancas, ambas em regra_itens:
--   1. linha adiada SAI da fila do mes de origem;
--   2. linha adiada ENTRA na fila do mes de destino, reconstruida a partir do
--      snapshot guardado em finance.faturamento_adiamentos.
--
-- O resto do corpo e copia exata da versao em producao.
-- =====================================================================
