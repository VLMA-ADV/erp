-- Feedback 20/07: converter proposta com arquivo -> solicitar contrato não levava o anexo.
-- A RPC aceita origem_card_id e copia os anexos do card do CRM para a solicitação.
